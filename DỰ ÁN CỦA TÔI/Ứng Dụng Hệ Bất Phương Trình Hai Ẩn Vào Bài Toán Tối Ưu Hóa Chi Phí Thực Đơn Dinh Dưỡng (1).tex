...
\begin{titlepage}
    ...
    {\huge \textbf{DỰ ÁN}}\\
    \vspace{0.5cm}
    {\Large \textbf{ỨNG DỤNG HỆ BẤT PHƯƠNG TRÌNH HAI ẨN VÀO BÀI TOÁN TỐI ƯU HÓA CHI PHÍ THỰC ĐƠN DINH DƯỠNG}}\\
    ...
    \textbf{Giảng viên giảng dạy} & : &Nguyễn Đăng Minh Phúc\\
        \textbf{Sinh viên thực hiện} & : &Thái Thị Mỹ Hoài \\
        \textbf{Mã sinh viên} & : &23S1010010
    \end{tabular}
...
\begin{titlepage}
    ...
    VÀO BÀI TOÁN TỐI ƯU HÓA CHI PHÍ
    THỰC ĐƠN DINH DƯỠNG
    }}
    ...
    \begin{tabular}{lcl}
        ...
        \textbf{Sinh viên thực hiện} & : & Thái Thị Mỹ Hoài\\[0.3cm]
        \textbf{Mã sinh viên} & : & 23S1010010
    \end{tabular}
    }
...
\subsection{Bất phương trình bậc nhất hai ẩn}
...
\subsection{Hệ bất phương trình bậc nhất hai ẩn}
...
\subsection{Miền nghiệm của hệ bất phương trình}
...
\subsection{Hàm mục tiêu và bài toán tối ưu}
...
\subsection{Một số điều kiện trong bài toán thực đơn}
...
\subsection{Ý nghĩa của việc áp dụng toán học vào bài toán thực đơn}
...
\section{XÂY DỰNG MÔ HÌNH VÀ THIẾT LẬP HỆ BẤT PHƯƠNG TRÌNH}

\subsection{Tình huống thực tế}
...
\subsection{Các giả định của mô hình}
...
\subsection{Bảng dữ liệu của mô hình}
...
\subsection{Xác định biến quyết định}
...
\subsection{Thiết lập các ràng buộc của mô hình}

\subsubsection{Ràng buộc về ngân sách}
...
\subsubsection{Ràng buộc về năng lượng}
...
\subsubsection{Ràng buộc về protein}
...
\subsubsection{Ràng buộc về rau xanh}
...
\subsubsection{ Điều kiện không âm}
...
\subsection{Hệ bất phương trình của mô hình}
...
\subsection{Xây dựng hàm mục tiêu chi phí}
...
\subsection{Kiểm tra tính khả thi của mô hình}
...
\subsection{Tính linh hoạt của mô hình}
...
\subsection{Ý nghĩa của mô hình}
...
\section{GIẢI VÀ PHÂN TÍCH BÀI TOÁN}
...
\subsection{Biểu diễn các đường biên}
...
\subsection{Xác định các đỉnh của miền nghiệm}
...
\subsection{Biểu diễn miền nghiệm trên mặt phẳng tọa độ}
...
\subsection{Xác định phương án tối ưu}
...
\subsection{Kiểm tra phương án tối ưu}
...
\subsection{Kết luận kết quả bài toán}
...
\section{ĐÁNH GIÁ VÀ MỞ RỘNG MÔ HÌNH}
...
\subsection{Ý nghĩa thực tiễn của mô hình}
...
\subsection{Hướng mở rộng mô hình}
